...
export const Sidebar: React.FC<SidebarProps> = ({
  ...
  return (
    <aside className="w-64 bg-white border-r border-slate-200/80 flex flex-col shrink-0 select-none shadow-[1px_0_4px_rgba(0,0,0,0.02)] h-screen sticky top-0">
      {/* Brand Header */}
      <div className="px-6 py-5 border-b border-slate-100 flex items-center justify-between">
        <div className="flex items-center gap-2.5">
          <div className="w-9 h-9 rounded-xl bg-linear-to-br from-blue-600 via-clinical-600 to-teal-500 flex items-center justify-center text-white shadow-md shadow-blue-500/20">
          ...
          <div>
            ...
            <p className="text-[11px] text-slate-400 font-medium leading-none">Clinical Intelligence</p>
          </div>
        </div>
      </div>
      ...
      <div className="p-3 border-t border-slate-100 bg-slate-50/50 space-y-2">
        ...
        <div 
          ...
          className="p-2 rounded-lg hover:bg-slate-100 transition-colors flex items-center justify-between cursor-pointer"
        >
